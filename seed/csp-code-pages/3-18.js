  ...
  problems: [
    ...
    },
    {
      ...
      pseudo: [
        ...
        '{',
        '  IF(x MOD 2 = 0) { x <- x / 2 } ELSE { x <- 3 * x + 1 }',
        '  steps <- steps + 1',
        '}',
        'IF(x = 1) { DISPLAY("halted after " + steps + " steps") }',
        'ELSE { DISPLAY("no answer within 50 steps") }',
      ],
      ...
      solution: {
        ...
        javascript: 'let x = 27;\nlet steps = 0;\nwhile (x !== 1 && steps < 50) {\n  if (x % 2 === 0) { x = x / 2; } else { x = 3 * x + 1; }\n  steps++;\n}\nif (x === 1) { console.log("halted after " + steps + " steps"); }\nelse { console.log("no answer within 50 steps"); }\n',
      },
    },
    {
      ...
      pseudo: [
        ...
        '  FOR EACH a IN [2..n]',
        '  {',
        '    IF(isPrime(a) AND isPrime(n - a)) { found <- true }',
        '  }',
        '  IF(NOT found) { DISPLAY(n) }',
        '}',
    ...
    },
    {
      ...
      pseudo: [
        ...
        '  steps <- steps + 1',
        '}',
        'IF(x > 500) { DISPLAY("yes, it halts in " + steps + " steps") }',
        'ELSE { DISPLAY("no, still running after 100 steps") }',
      ],
      ...
      solution: {
        ...
        javascript: 'let x = 1;\nlet steps = 0;\nwhile (x <= 500 && steps < 100) {\n  x = x * 2;\n  steps++;\n}\nif (x > 500) { console.log("yes, it halts in " + steps + " steps"); }\nelse { console.log("no, still running after 100 steps"); }\n',
      },
    },
  ],
};

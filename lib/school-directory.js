...
const DOMAINS = {
  ...
  // Best-effort map of the domains seen so far. Accuracy is best-effort (a wrong
  // row just mislabels a teacher in your own analytics); no `start` here, so these
  // fall back to the state-level start estimate. Correct or add as needed.
  'browardschools.com':       { district: 'Broward County Public Schools', city: 'Fort Lauderdale', state: 'FL', country: 'US' },
  'aquinas-sta.org':          { school: 'St. Thomas Aquinas High School', city: 'Fort Lauderdale', state: 'FL', country: 'US' },
  'psd150.org':               { district: 'Peoria Public Schools District 150', city: 'Peoria', state: 'IL', country: 'US' },
  'glenbard.org':             { district: 'Glenbard Township High School District 87', city: 'Glen Ellyn', state: 'IL', country: 'US' },
  'butlercollegeprep.org':    { school: 'Butler College Prep (Noble Schools)', city: 'Chicago', state: 'IL', country: 'US' },
  'fhps.net':                 { district: 'Forest Hills Public Schools', city: 'Grand Rapids', state: 'MI', country: 'US' },
  'taftschool.org':           { school: 'The Taft School', city: 'Watertown', state: 'CT', country: 'US' },
  'xavierhighschool.org':     { school: 'Xavier High School', city: 'Middletown', state: 'CT', country: 'US' },
  'southfayette.org':         { district: 'South Fayette Township School District', city: 'McDonald', state: 'PA', country: 'US' },
  'stargateschool.org':       { school: 'Stargate School', city: 'Thornton', state: 'CO', country: 'US' },
  'jamesirwin.org':           { school: 'James Irwin Charter Schools', city: 'Colorado Springs', state: 'CO', country: 'US' },
  'lexrich5.org':             { district: 'Lexington-Richland School District Five', city: 'Ballentine', state: 'SC', country: 'US' },
  'hhprep.org':               { school: 'Hilton Head Preparatory School', city: 'Hilton Head Island', state: 'SC', country: 'US' },
  'charlottecatholic.org':    { school: 'Charlotte Catholic High School', city: 'Charlotte', state: 'NC', country: 'US' },
  'wood-ridgeschools.org':    { district: 'Wood-Ridge School District', city: 'Wood-Ridge', state: 'NJ', country: 'US' },
  'pointpleasant.k12.nj.us':  { district: 'Point Pleasant Borough School District', city: 'Point Pleasant', state: 'NJ', country: 'US' },
  'aps.edu':                  { district: 'Albuquerque Public Schools', city: 'Albuquerque', state: 'NM', country: 'US' },
  'ccisd.net':                { district: 'Clear Creek ISD', city: 'League City', state: 'TX', country: 'US' },
  'tuhsd.org':                { district: 'Tempe Union High School District', city: 'Tempe', state: 'AZ', country: 'US' },
  'stratford.org':            { school: 'Stratford School', city: 'San Jose', state: 'CA', country: 'US' },
  'cvsd.net':                 { district: 'Central Valley School District', city: 'Spokane Valley', state: 'WA', country: 'US' },
  'faithlafayette.org':       { school: 'Faith Christian School', city: 'Lafayette', state: 'IN', country: 'US' },
  'ignatius.org':             { school: 'St. Ignatius High School', city: 'Cleveland', state: 'OH', country: 'US' },
  'saugus.k12.ma.us':         { district: 'Saugus Public Schools', city: 'Saugus', state: 'MA', country: 'US' },
  // International
  'dhafraschools.com':        { school: 'Al Dhafra Private Schools', city: 'Abu Dhabi', state: null, country: 'AE' },
  'aosr.org':                 { school: 'American Overseas School of Rome', city: 'Rome', state: null, country: 'IT' },
  'tasisengland.org':         { school: 'TASIS England', city: 'Thorpe', state: null, country: 'GB' },
  'cacegypt.org':             { school: 'Cairo American College', city: 'Cairo', state: null, country: 'EG' },
  'dakar-academy.org':        { school: 'Dakar Academy', city: 'Dakar', state: null, country: 'SN' },
  'ssbs.sh.cn':               { school: 'Shanghai Starriver Bilingual School', city: 'Shanghai', state: null, country: 'CN' },
  'suis.com.cn':              { school: 'Shanghai United International School', city: 'Shanghai', state: null, country: 'CN' },
};
...
const PERSONAL = new Set([
  ...
  // Common Chinese personal webmail
  '126.com', '163.com', 'qq.com', 'foxmail.com', '139.com', 'sina.com', 'sohu.com',
]);

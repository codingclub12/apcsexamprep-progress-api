...
${items}
  ...
  <div class="nextnav">
    ...
    ${unitTestLinks(bi.n, { esc, text: (l) => `Sit the ${bi.label.split(':')[0]} ${lowerFirst(l)}` })}
  </div>
</div>
${exerciseScript()}`;
...
function renderNotes(note) {
  ...
  //  The pointer names "MCQ Practice" because that is the heading a student
  //  actually sees on the lesson page, and says to finish the topic first
  //  because the page carries ONE six-question set rather than a matching set
  //  per section. Board 382: the 17 live BI1/2/4/5 notes pages shipped saying
  //  "CFUs", a label printed on no lesson page anywhere, and a paying teacher
  //  spent three weeks looking for it. These 18 are not live yet, so this is
  //  the cheap moment to not repeat it. Verified 2026-09-21 that BI3 lesson
  //  pages carry "MCQ Practice" once and six questions, same as the other 17.
...
<p class="sub">Fill these in during class, or catch up here if you were absent. Print this page or work on paper. When you have finished the whole topic, check yourself with the six MCQ Practice questions on the Topic ${t.topic} page.</p>
</div>

...
// Returns { link, token, expires_at, ttl_minutes }. The caller decides whether
...
module.exports = { RESET_TTL_MIN, sha256hex, resetBaseUrl, mintResetLink, findToken, burnTokens };

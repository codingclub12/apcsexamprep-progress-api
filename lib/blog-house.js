...
//
//  THE H1 RULE, AND WHY IT IS BACKWARDS FROM WHAT YOU EXPECT
//  Article pages on this theme render NO h1 at all: the Dawn article template
//  does not emit article.title as a heading. Measured 2026-08-18 against a live
//  daily-practice article and a live pillar guide. So the post body must carry
//  exactly one h1 itself. On /pages/ the opposite is true and the board already
//  tracks a three-h1 defect there. Do not copy a page pattern into an article.
//
...
function h1(text) { return `<h1>${raw(text)}</h1>`; }
...
module.exports = {
  ...
  h1, h2, h3, p, ul, ol, dek, byline, toc, box, code, table,

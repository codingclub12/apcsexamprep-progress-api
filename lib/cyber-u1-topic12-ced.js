...
const C6_FB_HTML = '<strong>B is correct.</strong> One password tried against many accounts, one or two attempts each. The password is the organisation\'s own default, which makes it a <strong>common password</strong> in the most literal sense: everyone was issued it and most people never changed it. Notice which signs were available. There was no burst of failed attempts to spot, one per account, but every one of those 34 logins came from a single external address, which is a device nobody had seen before.';
...
const C5_FB_FROM = '<div class="cfu-feedback-explain">';
const C5_FB_TO = '</div>';
const C5_FB_HTML = `<div class="cfu-feedback-explain">Correct sequence: <strong>personal information</strong>

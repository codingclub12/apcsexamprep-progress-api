 ...
 */
function transformPage(body, oldTopic, lessonId, targetPos, railScript) {
  ...
  if (targetPos == null) return { body: collapsed, counts, rail: 'skipped' };
  const { body: railed, action } = applyRail(collapsed, targetPos, railScript);
...
module.exports = {
  ...
  buildRail, applyRail, extractRailScript, transformPage, checkConsistency,
};

...
function renderJsonLd(entry, kind) {
  ...
  const crumbs = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: KIND_LABEL[kind], item: `${SITE}/pages/intro-java-help` },
...
${backToLesson}
  ...
  const body = [
    ...
    `<p>This page is part of <a href="${escAttr(`${SITE}/pages/intro-java`)}">Intro to Java with `

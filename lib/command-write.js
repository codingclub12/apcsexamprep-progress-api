...
// 'greenfoot' is kept as an accepted value, not renamed to 'intro-java', because
// tasks already carry it and a rename would orphan them into unknownCourseBlock.
// Both resolve to the same rulebook in lib/command-hazards.js.
const COURSES = ['csa', 'csp', 'cyber', 'networking', 'greenfoot', 'intro-java', 'all'];

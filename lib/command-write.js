...
function guard(existing, fields, who) {
  ...
  // Artifact gate applies to EVERY caller, cookie included. Closing without
  // evidence is the habit this table exists to break.
  if (String(fields.status || '').toLowerCase() === 'done') {

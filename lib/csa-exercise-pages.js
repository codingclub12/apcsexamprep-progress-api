...
module.exports = {
  allPages, renderExercise, esc, UNIT_HUBS, LESSONS, ITEM, COURSE,
  // Exported so lib/csa-debug-pages.js (a second code-editor item, id `debug`)
  // reuses the exact CSS and page script rather than carrying a second copy
  // that could drift from this one. Both are pure functions of an `id`, no
  // shared state.
  pageCss, pageScript,
};

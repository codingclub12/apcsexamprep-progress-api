...
/* Say what a selection looks like rather than inheriting it. On the storefront
   the theme's base stylesheet paints selections at 20 percent of the page
   foreground, which over a dark editor is invisible, and an editor that cannot
   show what is selected reads as broken even though the copy is correct. */
textarea.code::selection, textarea.stdin::selection {
  background: #2563eb; color: #ffffff; -webkit-text-fill-color: #ffffff; }
textarea.code::-moz-selection, textarea.stdin::-moz-selection {

...
(function () {
  ...
  function signOut() {
    state.token = null;
    state.who = null;
    try { localStorage.removeItem(TOKEN_KEY); localStorage.removeItem(WHO_KEY); } catch (e) {}
    renderAccount();
  }
  ...
  function confirmDiscard() {
    ...
    return window.confirm('You have unsaved changes. Open the other program anyway?');
  }

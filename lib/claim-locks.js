...
//
//  A session configured exactly as CLAUDE.md instructs therefore cannot claim
//  at all: POST /api/command/task/:id/claim answers 401 to the read token, both
//  as a bearer and bare. Measured 2026-09-03. That is a real inconsistency in
//  the rules and it is not this module's to fix. What this module can do is
//  make the DETECTION side work for every session regardless of credential, so
//  a session that cannot claim can still be stopped from trampling a session
//  that did.
//

...
//  503 joined 429 in PR 752, after verify-csa-qotd-dupes-live reported fine
//  pages as broken from its own request rate. The rest of the transient family
//  was still missing and is added here: a 500, 502, 504 or 408 is exactly as
//  transient as the two already listed. Every read through this module is an
//  idempotent GET, so retrying one is free of consequence in a way a POST
//  would not be.

...
const EXC2A_FROM = '&#9998; AP Exam Tip';
const EXC2A_HTML = '&#9998; How to read one of these';

const EXC2B_FROM = 'AI-based attacks on the AP exam always involve THREE elements: (1) an AI capability (voice cloning, deepfake, personalization, filter evasion), (2) a human psychological weakness being exploited (trust in a familiar voice/face, urgency, authority), and (3) a specific defense that addresses the human layer even when the AI deception is perfect.';
const EXC2B_HTML = 'An AI-based attack has three moving parts worth naming separately: an AI capability (voice cloning, deepfake, personalization, filter evasion), a human weakness it leans on (trust in a familiar voice or face, urgency, authority), and a defense that works on the human layer even when the deception itself is flawless.';
...
const SPLICES = [
  ...
  { name: 'exam tip block', from: EXC2A_FROM, html: EXC2A_HTML },
  { name: 'exam tip body', from: EXC2B_FROM, html: EXC2B_HTML },
];

...
// Every check file that exists, merged into one handle -> check index. Adding
// a topic's checks is adding a file here; nothing else changes.
function allChecks() {
  return Object.assign({}, require('../seed/csp-exercise-checks/1-1'));
}

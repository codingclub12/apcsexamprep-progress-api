...
function build(spec, index) {
  ...
  const bodyHtml = [
    '<div class="frq-page">',
    '<style>',
    // The cyber house style, same as the hubs. A student who clicks a purple
    // card and lands on a teal page has been handed two different products.
    '.frq-page{max-width:900px;margin:0 auto;font-family:Georgia,serif;color:#1F2937}',
    '.frq-page h1{font-family:"DM Serif Display",Georgia,serif;font-size:33px;line-height:1.2;',
    'color:#1E1B4B;font-weight:400;margin:0 0 14px}',
    '.frq-page .frq-page-lede{font-size:18px;line-height:1.65;color:#4B5563;margin:0 0 14px}',
    '.frq-page p{font-size:16.5px;line-height:1.7;margin:0 0 14px}',
    '.frq-page a{color:#6B21A8}',
    '.frq-page .frq-page-note{background:#F0FDF4;border:1px solid #BBF7D0;',
    'border-left:4px solid #15803D;padding:13px 17px;border-radius:0 10px 10px 0;margin:18px 0 26px}',
    '.frq-page .frq-sib{background:#F5F0FF;border:1px solid #e9d5ff;border-radius:14px;',
    'margin:38px 0 0;padding:22px 24px}',
    '.frq-page .frq-sib h2{font-family:"DM Serif Display",Georgia,serif;font-size:24px;',
    'color:#1E1B4B;font-weight:400;margin:0 0 8px}',
    '.frq-page .frq-sib-list{list-style:none;padding:0;margin:14px 0 16px}',
    '.frq-page .frq-sib-list li{background:#fff;border:1px solid #e9d5ff;border-radius:11px;',
    'padding:12px 15px;margin:0 0 9px}',
    '.frq-page .frq-sib-list a{font-family:"DM Serif Display",Georgia,serif;font-size:17px;',
    'text-decoration:none}',
    '.frq-page .frq-sib-list a:hover{text-decoration:underline}',
    '.frq-page .frq-sib-focus{display:block;font-family:"DM Sans",system-ui,sans-serif;',

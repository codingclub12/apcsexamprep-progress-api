...
const SOURCES = [
  ...
  //  AP Cyber units 2 to 5, 17 quizzes, moved off their page bodies on
  //  2026-09-08. GENERATED by scripts/build-cyber-quiz-seed.js, which parses the
  //  live pages rather than retyping them.
  //
  //  The bundle rule holds here too, and holds MORE easily: every one of these
  //  questions was already being served to anyone who opened the page, together
  //  with its answer key. Seeding them publishes nothing new and takes the key
  //  off 17 live pages. Each of these pages carries exactly five items where a
  //  bundle instrument carries nine to twenty-four, so none of them is a bundle
  //  quiz; that is a signal rather than a diff, because the .docx files are not
  //  in this repo, and no cyber teacher-files seed exists here either. The
  //  extractor refuses anything over six for that reason, which is what held
  //  back the ten-question 3.5 page.
  ...require('../seed/cyber-units-2-5-web-quizzes'),
];

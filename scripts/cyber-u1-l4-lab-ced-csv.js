...
'use strict';
// -----------------------------------------------------------------------------
//  BUILD THE MATRIXIFY SHEET FOR TOPIC 1.4 LAB.
//
//    node scripts/cyber-u1-l4-lab-ced-csv.js out/l4lab.csv [--live page.json]
...
const mod = require('../lib/cyber-u1-l4-lab-ced');
...
async function main() {
  ...
  if (!out) {
    console.error('usage: node scripts/cyber-u1-l4-lab-ced-csv.js <out.csv> [--live f.json] [--show-changes] [--html f.html]');
    process.exit(2);
  }

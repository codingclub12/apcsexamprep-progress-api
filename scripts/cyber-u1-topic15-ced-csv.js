...
'use strict';
// -----------------------------------------------------------------------------
//  BUILD THE MATRIXIFY SHEET FOR TOPIC 1.5.
//
//    node scripts/cyber-u1-topic15-ced-csv.js out/topic15.csv [--live page.json]
//                                             [--show-changes] [--html f.html]
//
//  ---- WHY THIS BUILD DOES TWO THINGS -----------------------------------------
//  Topic 1.5 needs a handful of splices AND the EK thinning pass. Matrixify
...
const mod = require('../lib/cyber-u1-topic15-ced');
...
async function main() {
  ...
  if (!out) {
    console.error('usage: node scripts/cyber-u1-topic15-ced-csv.js <out.csv> [--live f.json] [--show-changes] [--html f.html]');
    process.exit(2);
  }

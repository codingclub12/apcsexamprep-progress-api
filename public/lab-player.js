...
(function (global) {
  ...
  function injectStyles() {
    ...
    s.textContent = [
      ".apcs-lab{--ink:#12212e;--muted:#5a6b7a;--line:#dbe3ea;--bg:#fff;--accent:#2f6f8f;--ok:#1a7f4b;--no:#b3261e;",
      ...
      ".lab-chip{font-size:12px;padding:3px 9px;border-radius:999px;background:#eef3f7;color:var(--muted)}",
      ...
      ".lab-brief code,.lab-q code{font-family:ui-monospace,SFMono-Regular,Menlo,monospace;background:#eef3f7;padding:1px 5px;border-radius:4px;font-size:13px}",
      ...
      "border-radius:999px;background:#eef3f7;color:var(--muted);vertical-align:middle}",

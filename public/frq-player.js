(function (global) {
  ...
  function injectStyles(doc) {
    ...
    s.textContent = [
      ...
      '.apcs-frq .frq-meta{background:#F5F0FF;border-left:3px solid #6B21A8;border-radius:0 6px 6px 0;padding:11px 15px;margin:0 0 18px;font-size:14.5px;}',
      '.apcs-frq .frq-src{border:1px solid #e9d5ff;border-radius:8px;margin:0 0 14px;overflow:hidden;}',
      '.apcs-frq .frq-src-h{background:#FAF5FF;border-bottom:1px solid #e9d5ff;padding:9px 13px;font-weight:700;font-size:14.5px;}',
      '.apcs-frq .frq-src-cmd{font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:13px;color:#6B7280;padding:7px 13px 0;}',
      ...
      '.apcs-frq th,.apcs-frq td{border:1px solid #e9d5ff;padding:5px 9px;text-align:left;white-space:nowrap;}',
      '.apcs-frq th{background:#FAF5FF;font-size:12px;text-transform:uppercase;letter-spacing:.03em;}',
      '.apcs-frq .frq-part{border:1px solid #e9d5ff;border-radius:8px;padding:14px 16px;margin:0 0 14px;}',
      '.apcs-frq .frq-stem{font-style:italic;color:#4B5563;margin:0 0 10px;}',
      '.apcs-frq .frq-sub{margin:0 0 14px;padding:0 0 0 14px;border-left:2px solid #E9D5FF;}',
      '.apcs-frq .frq-verb{display:inline-block;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.04em;background:#EDE9FE;color:#6B21A8;border-radius:4px;padding:2px 7px;margin-right:7px;}',
      '.apcs-frq .frq-btn{font:inherit;font-size:14px;background:#6B21A8;color:#fff;border:0;border-radius:6px;padding:7px 14px;cursor:pointer;margin-top:8px;}',
      '.apcs-frq .frq-btn:hover{background:#581C87;}',
